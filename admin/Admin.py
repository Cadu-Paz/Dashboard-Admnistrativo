...
def start_views(app, db):
    ...
    admin.add_view(GenericView(Disease, db.session, "Doenças"))
    admin.add_view(GenericView(Patient, db.session, "Pacientes"))
    admin.add_view(GenericView(DiseaseState, db.session, "Estados de Saúde"))
